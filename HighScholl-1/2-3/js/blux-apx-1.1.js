...
bx.HCL = {
  ...
  getViewportWidth: function () {
    ...
    var e;
    if (
      bx.HCL.DV.supportCSS3() &&
      bx.HCL.DV.isMobile() &&
      (e = bx.$getMeta("viewport"))
    ) {
      var c;
...
bx.Event = {
  ...
  isRightButton: function (c) {
    if (
      c.type == "mousedown" &&
      !(c.which == 3 || (bx.$50.$0a[1] == "msie" && c.button == 2))
    ) {
      return false;
    }
    return true;
  ...
  init: function (e) {
    ...
    if (this.$DF.resize) {
      if (this.$DF.resize == "portrait" || this.$DF.resize == "landscape") {
        ...
        if (
          this.$DF.resize == "orientationchange" ||
          this.$DF.resize == "resize"
        ) {
      ...
      if (bx.$50.$0a[1] == "iphone" && parseInt(bx.HCL.$0a[3]) >= 11) {
        ...
        if (bx.$50.$0a[1] == "iphone" && window.devicePixelRatio >= 2) {
          ...
          if (
            ...
            if (
              bx.$50.$0a[1] == "iphone" &&
              bx.$checkNaN(parseInt(bx.$50.$0a[3])) >= 5
            ) {
              g = 1;
            } else {
      ...
      if (h.type == "orientationchange") {
        if (bx.UX.$DF.type & bx.UX.SYS_NO_ADDR_BAR) {
          ...
          setTimeout(function () {
            ...
            if (bx.CWnd) {
              bx.UX.$52.onResize(
                { x: 0, y: 0, w: bx.UX.width, h: bx.UX.height },
                1
              );
            }
          }, 1);
  ...
  if (this.$43) {
    ...
    if (this.$42 && this.$42.console) {
      if (!this.$44) {
        ...
        this.cfg.console.width =
          this.cfg.console.width || parseInt(bx.UX.width / 2) + "px";
        this.cfg.console.height =
          this.cfg.console.height || parseInt(bx.UX.height / 2) + "px";
    ...
    case "flipBottom":
      if (g) {
        if (bx.HCL.DV.isChrome()) {
          i.$CSS(
            "perspective",
            Math.max(i.offsetWidth, i.offsetHeight) * 2.3 + "px"
          );
        } else {
          i.$CSS(
            "perspective",
            Math.max(i.offsetWidth, i.offsetHeight) * 2.8 + "px"
          );
        }
      }
  ...
  if (s) {
    ...
    switch (p) {
      case "glueLeft":
        ...
        j.$CSS({
          animation:
            l("moveFromRight") + " " + Math.floor(c * 0.7) + "ms ease both",
      ...
      case "glueRight":
        ...
        j.$CSS({
          animation:
            l("moveFromLeft") + " " + Math.floor(c * 0.7) + "ms ease both",
          animationDelay: Math.floor(c * 0.3) + "ms",
        });
        break;
      case "glueTop":
        ...
        j.$CSS({
          animation:
            l("moveFromBottom") + " " + Math.floor(c * 0.7) + "ms ease both",
          animationDelay: Math.floor(c * 0.3) + "ms",
        });
        break;
      case "glueBottom":
        ...
        j.$CSS({
          animation:
            l("moveFromTop") + " " + Math.floor(c * 0.7) + "ms ease both",
          animationDelay: Math.floor(c * 0.3) + "ms",
        });
        break;
      case "fall":
      ...
      case "timeLagLeft":
        ...
        h.animation =
          l("moveFromRight") + " " + Math.floor(c * 0.85) + "ms ease both";
        f();
        j.$CSS(h);
        break;
      case "timeLagRight":
        ...
        h.animation =
          l("moveFromLeft") + " " + Math.floor(c * 0.85) + "ms ease both";
        f();
        j.$CSS(h);
        break;
      case "timeLagTop":
        ...
        h.animation =
          l("moveFromBottom") + " " + Math.floor(c * 0.85) + "ms ease both";
        f();
        j.$CSS(h);
        break;
      case "timeLagBottom":
        ...
        h.animation =
          l("moveFromTop") + " " + Math.floor(c * 0.85) + "ms ease both";
        f();
        j.$CSS(h);
        break;
      case "cornerLeft":
      ...
      case "newspaper":
        ...
        k.$CSS({
          ...
          animation:
            "rotateOutNewspaper " + Math.floor(c / 2) + "ms both ease-in",
        });
        j.$CSS({
          transformOrigin: "50% 50%",
          animation:
            "rotateInNewspaper " + Math.floor(c / 2) + "ms both ease-out",
  ...
  if (bx.CMessageDialog) {
    if (!bx.UX.$5f[e]) {
      var d = {
        size: c.size,
        buttons: {},
        CMessageDialog: { cssMessage: bx.UX.cfg.cssMessage },
      };
      if (c.layout) {
        d.layout = c.layout;
      }
      ...
      bx.UX.$5f[e] = new bx.CMessageDialog(
        c.title || "Message",
        {},
        d
      ).create();
...
bx.UX.showToast = function (d, c) {
  if (window.bluega && bluega.UTIL_showToastText) {
    ...
    bx.UX.$35.style.left =
      parseInt((bx.UX.width - bx.UX.$35.offsetWidth) / 2) + "px";
    if (bx.UX.$35.$3S) {
  ...
  if (g == 1) {
    ...
    if (this.data.type == "ondeck") {
      ...
      if (
        this.data.width &&
        this.data.width.normal &&
        this.data.width.normal != "auto"
      ) {
        i = parseInt(
          bx.CPosition.$3X(h, "width", this.data.coord, this.data.width.normal)
        );
        if (!this.data.noclip && i > h.w) {
          f = h.w;
        } else {
...
bx.CPosition.prototype.isMovable = function () {
  if (this.data.type == "overlap") {
    if (
      !(this.data.coord && (this.data.coord.hcenter || this.data.coord.vcenter))
    ) {
      return true;
    }
  }
  ...
  if (!this.parent) {
    if (bx.UX.$DF.rootTag) {
      ...
      this.tagVP = this.tag.$TAG("DIV", {
        style:
          "position:relative;width:100%;height:100%;border:none;padding:0;margin:0",
      });
    } else {
  ...
  if (!arguments || arguments.length > 0) {
    ...
    if (typeof e != "string") {
      bx.Trace.log(
        "BLUX",
        "errorParameter",
        "tagId is not instance of string",
        "CWnd()"
      );
      g = true;
    }
    if (i && typeof i != "string") {
      bx.Trace.log(
        "BLUX",
        "errorParameter",
        "title is not instance of string",
        "CWnd()"
      );
      g = true;
    }
    if (f && !(f instanceof bx.CWnd)) {
      bx.Trace.log(
        "BLUX",
        "errorParameter",
        "parent is not instance of bx.CWnd",
        "CWnd()"
      );
      g = true;
    }
    if (!(h instanceof bx.CMode)) {
      bx.Trace.log(
        "BLUX",
        "errorParameter",
        "mode is not instance of bx.CMode",
        "CWnd()"
      );
      g = true;
    }
    if (!(c instanceof bx.CPosition)) {
      bx.Trace.log(
        "BLUX",
        "errorParameter",
        "position is not instance of bx.CPosition",
        "CWnd()"
      );
      g = true;
    }
    ...
    if (
      this.opts.classNameWnd === undefined &&
      bx.HCL.getCssRule(".bxCWnd_window")
    ) {
      this.opts.classNameWnd = "bxCWnd_window";
    }
    if (
      this.opts.className === undefined &&
      bx.HCL.getCssRule(".bxCWnd_viewport")
    ) {
      this.opts.className = "bxCWnd_viewport";
    }
    if (this.opts.titleBar) {
      this.opts.titleBar.height =
        this.opts.titleBar.height || bx.CWnd.cfg.titleBar.height;
      if (
...
bx.CWnd.prototype.$F0 = function (c, e) {
  ...
  if (this.opts.titleBar) {
    ...
    if (this.opts.titleBar.btnClose && this.opts.titleBar.btnClose.normal) {
      this.$3O = this.tag.$TAG(
        "img",
        {
          ...
          class: this.opts.titleBar.btnClose.css
            ? this.opts.titleBar.btnClose.css
            : "",
          onclick:
            'var wnd = $W("' + this.tagId + '"); wnd.hide(); wnd.onClose();',
        },
        { position: "absolute" }
      );
    ...
    if (this.opts.titleBar.onLongClick || this.opts.titleBar.onPreLongClick) {
      var d =
        "bx.Event.mouseDrag(this, event, null, null, {nodrag:true, $ZZ09:true, $ZZ07:true";
      d += this.opts.titleBar.cssHover
        ? ", cssDrag:'" + this.opts.titleBar.cssHover + "'"
        : "";
      d += "});";
      if (bx.HCL.DV.hasTouchEvent()) {
...
bx.CWnd.prototype.$5t = function (d, c, f, e) {
  bx.CWnd.prototype.$5t.$39 = bx.HCL.getElementRect(
    d,
    bx.CWnd.prototype.$5t.$39
  );
  e = e || {};
...
bx.CWnd.prototype.onResize = function (j, i, e, f) {
  ...
  if (g) {
    ...
    if (this.$3O) {
      this.$3O.style.right =
        bx.$checkNaN(parseInt(this.tag.$css("padding-right"))) + "px";
...
bx.EM = {
  ...
  refresh: function (d) {
    for (var c = 0; c < bx.EM.$2Y.length; c++) {
      if (bx.EM.$2Y[c].id == d) {
        if (bx.EM.$2Y[c].timer) {
          bx.EM.$2Y[c].timer.last =
            new Date().getTime() + bx.EM.$2Y[c].timer.time;
        }
        break;
      }
    }
      ...
      if (this.$N1l.styles) {
        for (this.$N1n in this.$N1l.styles) {
          if (this.$N1l.styles[this.$N1n].sequence) {
            if (
              (this.$N1m == 1 && !this.$N1l.roundUp) ||
              (this.$N1m == 0 && this.$N1l.roundUp)
            ) {
            ...
            if (typeof this.$N1l.styles[this.$N1n].unit == "function") {
              ...
              this.$N1l.element.$CSS(
                this.$N1n,
                this.$N1B + this.$N1l.styles[this.$N1n].unit
              );
            }
          }
        }
...
bx.CPageManager = function (e, c, d) {
  ...
  d = d || {};
  d.type = d.type
    ? d.type | bx.CWnd.TYPE_NO_VIEWPORT
...
bx.CPageManager.prototype.$2U = function (c) {
  if (this.$2Q.length > 1) {
    if (c) {
      ...
      while (
        this.$2Q.length > 0 &&
        this.get(this.$2Q[this.$2Q.length - 1]).dialog
      ) {
        this.$2Q.pop();
      }
...
bx.CPageManager.prototype.historyAdd = function (c, d) {
  if (this.$2Q.length >= c) {
    if (
      !(this.$2Q.length - c - 1 >= 0 && this.$2Q[this.$2Q.length - c - 1] == d)
    ) {
...
bx.CPageManager.prototype.canRun = function (g, d, c) {
  ...
  if (
    bx.PageTransition &&
    bx.PageTransition.isInTransit(this.get(g).tag.parentNode)
  ) {
    return;
  }
  var f;
  ...
  if (c == g && !(f && f.dialog)) {
    bx.Trace.log(
      "BLUX",
      "warning",
      "CPage=" + g + " run is ignored by duplication",
      "pages.run"
    );
    return false;
  }
...
bx.CPageManager.prototype.run = function (f, q, k) {
  ...
  if (k == f && !(i && i.dialog)) {
    bx.Trace.log(
      "BLUX",
      "warning",
      "CPage=" + f + " run is ignored by duplication",
      "pages.run"
    );
    return;
  }
...
bx.CPage2 = function (f, g, c, e, d) {
  ...
  e.type = e.type
    ? e.type | bx.CWnd.TYPE_NO_VIEWPORT
    : bx.CWnd.TYPE_NO_VIEWPORT;
  e.styles = e.styles || {};
...
bx.CGesture = function (q, p, d) {
  ...
  if (!q || !p) {
    bx.Trace.log(
      "BLUX",
      "error",
      "Parameter error; tag=" + q + ", onEvent=" + p,
      "CGesture()"
    );
    return;
  }
...
bx.CGesture.$N0e = function (g, c, f, l) {
  ...
  if (!bx.HCL.DV.hasTouchEvent()) {
    ...
    if (
      bx.HCL.DV.isIE() &&
      !(bx.HCL.DV.isIE() > 9 && bx.UX && bx.UX.type & bx.UX.SYS_SELECTABLE)
    ) {
      if (h.setCapture) {
        h.setCapture(true);
      }
...
bx.CGesture.prototype.$DM = function (n, f) {
  ...
  if (
    this.$N0W &&
    l == bx.CGesture.POINTER_END &&
    (this.$N1s == bx.CGesture.POINTER_DRAG ||
      this.$N1s == bx.CGesture.POINTER_START)
  ) {
    if (
    ...
    if (
      ...
      if (this.$N1v && this.$N1v.use) {
        ...
        var k;
        var j =
          Math.min(bx.HCL.getViewportWidth(), bx.HCL.getViewportHeight()) * 0.1;
  ...
  function q(ag, S) {
    ...
    for (af = 0; af < ai.length; af++) {
      if (Y[af]) {
        ...
        if (N) {
          bx.CCanvasWnd.drawTextUnderline(
            L,
            ai[af],
            X[af],
            W[af],
...
bx.CCanvasWnd.intersect_circle_line = function (c, i, h, e, g, d, f) {
  ...
  if (
    (bx.CCanvasWnd.$HuC * bx.CCanvasWnd.$Hu9 -
      bx.CCanvasWnd.$HuB * bx.CCanvasWnd.$HuA) *
      (bx.CCanvasWnd.$HuC * bx.CCanvasWnd.$Hu9 -
        bx.CCanvasWnd.$HuB * bx.CCanvasWnd.$HuA) <=
    h *
      h *
      (bx.CCanvasWnd.$Hu9 * bx.CCanvasWnd.$Hu9 +
        bx.CCanvasWnd.$HuA * bx.CCanvasWnd.$HuA)
  ) {
    if (
      bx.CCanvasWnd.$HuB * bx.CCanvasWnd.$HuB +
        bx.CCanvasWnd.$HuC * bx.CCanvasWnd.$HuC <=
      h * h
    ) {
    ...
    if (
      (bx.CCanvasWnd.$Hu9 - bx.CCanvasWnd.$HuB) *
        (bx.CCanvasWnd.$Hu9 - bx.CCanvasWnd.$HuB) +
        (bx.CCanvasWnd.$HuA - bx.CCanvasWnd.$HuC) *
          (bx.CCanvasWnd.$HuA - bx.CCanvasWnd.$HuC) <=
      h * h
    ) {
    ...
    if (
      !bx.CCanvasWnd.$HuD &&
      !bx.CCanvasWnd.$HuE &&
      bx.CCanvasWnd.$HuB * bx.CCanvasWnd.$Hu9 +
        bx.CCanvasWnd.$HuC * bx.CCanvasWnd.$HuA >=
        0 &&
      bx.CCanvasWnd.$HuB * bx.CCanvasWnd.$Hu9 +
        bx.CCanvasWnd.$HuC * bx.CCanvasWnd.$HuA <=
        bx.CCanvasWnd.$Hu9 * bx.CCanvasWnd.$Hu9 +
...
bx.CCanvasWnd.intersect_point_polygon = function (k, h, l) {
  ...
  if (l.length == 2) {
    ...
    return bx.CCanvasWnd.intersect_point_rect(
      k,
      h,
      l[0].x,
      l[0].y,
...
bx.CCanvasWnd.$5xe = function (o, e) {
  ...
  for (h = 0; h < e.length; h++) {
    ...
    e[h].$5xg = undefined;
    if (
      bx.CCanvasWnd.intersect_rect_rect(m.x, m.y, m.w, m.h, l.x, l.y, l.w, l.h)
    ) {
      e[h].$5xg = true;
      c = true;
    }
...
bx.PageDrag = function (m, q, c, n, p, s, o) {
  ...
  function u(B, A, z) {
    if (
      o &&
      o.fnCanDrag &&
      !o.fnCanDrag(undefined, s == "x" ? B : A, s == "x" ? B : A)
    ) {
      return;
    }
  ...
  function f(B, A, z) {
    if ((B - t) / parseInt(m.style.width)) {
      if (
        o &&
        o.fnCanDrag &&
        !o.fnCanDrag((B - t) / parseInt(m.style.width) < 0 ? -1 : 1, t, B)
      ) {
        return;
      }
    }
  ...
  if (window.apn && apn.CExe && m.apnOID) {
    ...
    m.apxOnDragStart = function (A, D, C, B) {
      ...
      if (z.tagName == "INPUT" || z.tagName == "TEXTAREA") {
        if (
          z.getAttribute("readonly") === null &&
          z.getAttribute("disabled") === null
        ) {
          return false;
        }
      } else {
...
bx.PageDrag.$CQ = function (i, n, e, l, c) {
  ...
  var f = Math.max(
    1,
    Math.ceil(500 * (Math.abs(k) < 0.5 ? Math.abs(k) : 1 - Math.abs(k)))
  );
  j.id = "BxPD$" + bx.PageDrag.$5x5++;
  j.element = i;
  j.time = f;
        ...
        if (l < 0) {
          ...
          if (j.bxPageDrag.dir == "x") {
            ...
            j.bxPageDrag.tagC.$CSS({
              transformOrigin: "100% 50%",
              transform:
                "translateX(" + l * 100 + "%) rotateY(" + l * 90 + "deg)",
            });
            if (j.bxPageDrag.tagRB) {
              j.bxPageDrag.tagRB.$CSS({
                transformOrigin: "0% 50%",
            ...
            j.bxPageDrag.tagC.$CSS({
              transformOrigin: "50% 100%",
              transform:
                "translateY(" + l * 100 + "%) rotateX(" + -l * 90 + "deg)",
            });
            if (j.bxPageDrag.tagRB) {
              j.bxPageDrag.tagRB.$CSS({
                transformOrigin: "50% 0%",
